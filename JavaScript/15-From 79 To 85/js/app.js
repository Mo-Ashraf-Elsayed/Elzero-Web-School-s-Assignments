...
// console.log(myFavGames..hasOwnProperty('name'))
...
for (let i = 0; i < objectLength; i++) {
  ...
  // console.log(`The Publisher Is ${Object.values(myFavGames[Object.keys(myFavGames)[i]]).filter(ele=>ele !="[object Object]")[0]}`);
  // console.log(`The Price Is ${Object.values(myFavGames[Object.keys(myFavGames)[i]]).filter(ele=>ele !="[object Object]")[1]}`);
